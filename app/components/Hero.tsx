    ...
    return (
        <section id='hero'>
            <div className="cursor-auto md:cursor-none h-[100vh] lg:mt-40">
                ...
                <div
                    className="lg:h-[15rem] h-[50vh] text-center font-bold lg:w-[48rem] text-8xl w-[70dvw] lg:ml-[23dvw] ml-[15dvw] rounded-lg p-0 relative lg:bottom-[60vh] bottom-[75vh] opacity-0 flex flex-col gap-5"
                    ref={me}
                    style={{
                ...
                >
                    <div className="rounded-full h-[150px] w-[140px] relative top-8 left-24">
                ...
                <div className="relative bottom-[65vh] lg:bottom-[45vh] left-[45dvw] w-[30dvw] opacity-0" ref={scroll}>
                    <p>Scroll Down</p>
